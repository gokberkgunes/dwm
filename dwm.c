...
struct Client {
	...
	int bw, oldbw;
	unsigned int tags;
	int isfixed, isfloating, isurgent, neverfocus, oldstate, isfullscreen, issticky, isterminal, noswallow, defmon;
	pid_t pid;
	Client *next;
	Client *snext;
	Client *swallowing;
...
focusmon(const Arg *arg)
{
	...
	/* move move to other monitor's center if there is nothing to focus */
